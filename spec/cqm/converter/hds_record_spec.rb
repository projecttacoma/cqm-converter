...
RSpec.describe CQM::Converter::HDSRecord do
  ...
  it 'converts HDS to QDM and maintains id' do
    ...
    cqm_eh_id_test = @hds_record_converter.to_qdm(hds_eh_id_test)
    ...
    cqm_eh_id_test_json = JSON.parse(to_utc(cqm_eh_id_test.to_json(except: '_id').to_s)).clean_hash
  ...
  it 'converts HDS to QDM and handles relatedTo' do
    ...
    cqm_eh_relatedto_test = @hds_record_converter.to_qdm(hds_eh_relatedto_test)
  ...
  it 'converts HDS EH 1 to QDM EH 1 properly' do
    ...
    cqm_eh1 = @hds_record_converter.to_qdm(hds_eh1)
    ...
    cqm_eh1_json = JSON.parse(to_utc(cqm_eh1.to_json(except: ['_id', 'id']).to_s)).clean_hash
